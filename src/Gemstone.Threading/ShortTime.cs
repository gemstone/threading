...
namespace Gemstone.Threading
{
    ...
    internal struct ShortTime : IEquatable<ShortTime>
    {
        ...
        private ShortTime(long time) => m_time = time;

        /// <summary>
        /// Calculates the approximate <see cref="DateTime"/> represented by this time. 
        /// </summary>
        /// <returns></returns>
        public DateTime UtcTime => DateTime.UtcNow - Elapsed();

        /// <summary>
        /// The elapsed time in seconds.
        /// </summary>
        /// <returns></returns>
        public double ElapsedSeconds() => ElapsedSeconds(Now);

        /// <summary>
        /// The elapsed time in milliseconds.
        /// </summary>
        /// <returns></returns>
        public double ElapsedMilliseconds() => ElapsedMilliseconds(Now);

        /// <summary>
        /// The elapsed time in microseconds.
        /// </summary>
        /// <returns></returns>
        public double ElapsedMicroseconds() => ElapsedMicroseconds(Now);

        /// <summary>
        /// The elapsed time in ticks.
        /// </summary>
        /// <returns></returns>
        public double ElapsedTicks() => ElapsedTicks(Now);

        /// <summary>
        /// Gets the time that has elapsed since the creation of this time.
        /// </summary>
        /// <returns></returns>
        public TimeSpan Elapsed() => Elapsed(Now);

        /// <summary>
        /// The elapsed time in seconds
        /// </summary>
        public double ElapsedSeconds(ShortTime futureTime) => ShortTimeFunctions.ElapsedSeconds(m_time, futureTime.m_time);

        /// <summary>
        /// The elapsed time in milliseconds
        /// </summary>
        public double ElapsedMilliseconds(ShortTime futureTime) => ShortTimeFunctions.ElapsedMilliseconds(m_time, futureTime.m_time);

        /// <summary>
        /// The elapsed time in microseconds
        /// </summary>
        public double ElapsedMicroseconds(ShortTime futureTime) => ShortTimeFunctions.ElapsedMicroseconds(m_time, futureTime.m_time);

        /// <summary>
        /// The elapsed time in ticks
        /// </summary>
        public double ElapsedTicks(ShortTime futureTime) => ShortTimeFunctions.ElapsedTicks(m_time, futureTime.m_time);
        ...
        /// Tests Less Than
        /// </summary>
        public static bool operator <(ShortTime a, ShortTime b) => a.m_time - b.m_time < 0; // Accounts for overflows.
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public static TimeSpan operator -(ShortTime a, ShortTime b) => b.Elapsed(a);

        /// <summary>
        /// Are 2 times equal
        /// </summary>
        public static bool operator ==(ShortTime a, ShortTime b) => b.m_time == a.m_time;
        ...
        public bool Equals(ShortTime other) => m_time == other.m_time;

        /// <summary>Returns the hash code for this instance.</summary>
        /// <returns>A 32-bit signed integer that is the hash code for this instance.</returns>
        /// <filterpriority>2</filterpriority>
        public override int GetHashCode() => m_time.GetHashCode();

        /// <summary>
        /// Shows the UTC time.
        /// </summary>
        public override string ToString() => UtcTime.ToString();
    }
}

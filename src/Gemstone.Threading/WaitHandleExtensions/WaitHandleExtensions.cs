...
using GemstoneCancellationToken = Gemstone.Threading.Cancellation.CancellationToken;
...
namespace Gemstone.Threading.WaitHandleExtensions
{
    ...
    public static class WaitHandleExtensions
    {
        ...
        /// <param name="cancellationToken">A <see cref="System.Threading.CancellationToken"/> to observe, if any.</param>
        ...
        /// </remarks>
        public static bool WaitAll(this IEnumerable<ManualResetEventSlim> resetEvents, GemstoneCancellationToken? cancellationToken = null)
        {
            if (resetEvents == null)
                throw new ArgumentNullException(nameof(resetEvents));

            return cancellationToken == null ? 
                resetEvents.AllParallel(resetEvent => { resetEvent.Wait(); return true; } ) : 
                resetEvents.WaitAll(new CompatibleCancellationToken(cancellationToken));
        }
        ...
        /// incurring unconditional inflation of the underlying <see cref="ManualResetEvent"/>.
        /// </remarks>
        public static bool WaitAll(this IEnumerable<ManualResetEventSlim> resetEvents, CancellationToken cancellationToken)
        {
            if (resetEvents == null)
                throw new ArgumentNullException(nameof(resetEvents));
        ...
        /// <param name="cancellationToken">A <see cref="GemstoneCancellationToken"/> to observe, if any.</param>
        ...
        /// incurring unconditional inflation of the underlying <see cref="ManualResetEvent"/>.
        /// </remarks>
        public static bool WaitAll(this IEnumerable<ManualResetEventSlim> resetEvents, int timeout, GemstoneCancellationToken? cancellationToken = null)
        {
            if (resetEvents == null)
                throw new ArgumentNullException(nameof(resetEvents));

            return cancellationToken == null ? 
                resetEvents.AllParallel(resetEvent => resetEvent.Wait(timeout)) : 
                resetEvents.WaitAll(timeout, new CompatibleCancellationToken(cancellationToken));
        }
        ...
        /// incurring unconditional inflation of the underlying <see cref="ManualResetEvent"/>.
        /// </remarks>
        public static bool WaitAll(this IEnumerable<ManualResetEventSlim> resetEvents, int timeout, CancellationToken cancellationToken)
        {
            if (resetEvents == null)
                throw new ArgumentNullException(nameof(resetEvents));
        ...
        /// incurring unconditional inflation of the underlying <see cref="ManualResetEvent"/>.
        /// </remarks>
        public static bool WaitAll(this IEnumerable<ManualResetEventSlim> resetEvents, TimeSpan timeout, GemstoneCancellationToken? cancellationToken = null)
        {
            if (resetEvents == null)
                throw new ArgumentNullException(nameof(resetEvents));
        ...
        /// incurring unconditional inflation of the underlying <see cref="ManualResetEvent"/>.
        /// </remarks>
        public static bool WaitAll(this IEnumerable<ManualResetEventSlim> resetEvents, TimeSpan timeout, CancellationToken cancellationToken)
        {
            if (resetEvents == null)
                throw new ArgumentNullException(nameof(resetEvents));
